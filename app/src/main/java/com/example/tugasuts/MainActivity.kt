...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        etNamaBelakang = findViewById(R.id.editLastName)
        etPassword = findViewById(R.id.editTextPassword)
        etConfirmPassword = findViewById(R.id.editTextUlangPassword)
        btnKirim = findViewById(R.id.buttonSubmit)   // pada layout btnCancel bertuliskan "Kirim"
        btnBatal = findViewById(R.id.buttonCancel)   // pada layout btnSubmit bertuliskan "Batal"
